...
- **The script is a `.fountain` file, not a note** (`src/fountain.ts`, `src/views/script-view.tsx`).
  ...
  location: the same house is INT. in one scene and EXT. in the next.
